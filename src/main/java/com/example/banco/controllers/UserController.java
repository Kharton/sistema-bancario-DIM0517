...
public class UserController {
	...
	public ResponseEntity<User> creditUser(@PathVariable String numUser,
	...
	public ResponseEntity<User> debitUser(@PathVariable String numUser,
			@RequestBody User user) {
	...
	public ResponseEntity<User> transfer(@RequestBody AtoTransferencia atoTransferencia) {
		User origin_user = userService.transfer(atoTransferencia.getFrom(),
				atoTransferencia.getTo(), atoTransferencia.getAmount());
